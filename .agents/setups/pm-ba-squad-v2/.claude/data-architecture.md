...
```
<!-- Paste the Prisma schema or main tables here -->
```
...
- Table naming: plural snake_case (users, bookings, ...)
...
<!-- Rules for writing migrations without downtime -->

- Always backward compatible (add nullable column first)
- Never DROP COLUMN without a 2-step migration
