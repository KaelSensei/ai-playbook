...
<!-- Update the thresholds and flows at the start of the project -->
...
- Load tests: k6 / Artillery (choose)
...
- [ ] Login with valid email/password → dashboard redirect
